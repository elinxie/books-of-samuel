...
/**
 * Instanced ground cover, the same Judean-highland palette and composition
 * as the other Hebron M5 scenes' Vegetation.tsx (mandatory visual
 * continuity — same scatter shape around the same `TOWN_CENTER`, a fresh
 * but identically-distributed generator rather than a shared module, per
 * ADR-006's "layout code stays scene-local" convention, exactly as
 * hebron-gate's own Vegetation.tsx documents).
 */
