...
describe('hebron-covenant terrain (reused from hebron-anointing)', () => {
  ...
  it('keeps the town mound above the valley, same as hebron-anointing', () => {
  ...
  it('is finite well north of the town, along the new north-road approach', () => {
    const h = HEBRON_TERRAIN.heightAt(55, -280);
