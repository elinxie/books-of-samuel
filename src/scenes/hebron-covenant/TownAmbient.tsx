...
/**
 * Ambient town background (`claim-covenant-cast-scale`) — a working town on
 * an ordinary day, deliberately far below hebron-anointing's 150-200-figure
 * civic assembly (brief's "Scale assumptions": "that was a public founding,
 * this is a closed political meal"). A genuinely static crowd, same cost
 * precedent as hebron-anointing's JudahAssembly.tsx and this scene's own
 * DavidsSideFeast.tsx — baked idle pose buckets, all matrices written once
 * in a setup effect, never `useFrame`.
 */
...
export function buildAmbientFigures(count: number, seed = 230601): AmbientFigure[] {
