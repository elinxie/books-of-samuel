 ...
 * as hebron-anointing's Vegetation.tsx (mandatory visual continuity — same
 * scatter shape around the same `TOWN_CENTER`, a fresh but identically-
 * distributed generator rather than a shared module, per ADR-006's
 * "layout code stays scene-local" convention).
 */
