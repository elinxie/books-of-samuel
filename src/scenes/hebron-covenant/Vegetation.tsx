...
/**
 * Instanced ground cover for Hebron — the same Judean-highland palette
 * hebron-anointing established (olive groves on the terraced slopes, scrub,
 * surface rock), reused here rather than re-invented (brief's "Visual
 * continuity... is mandatory"). Scene-local component per ADR-006; the
 * placement algorithm mirrors hebron-anointing/Vegetation.tsx.
 */
