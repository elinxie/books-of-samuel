...
/**
 * Hebron itself: the same modest hill-town cluster hebron-anointing built
 * (`claim-hebron-town-form`, `asset-hebron-town-form`), reused by importing
 * its layout data directly rather than re-generating a new town — this is
 * the same place a few years later, not a re-invented settlement (brief's
 * "Visual continuity... is mandatory", "not allowed: divergence from
 * hebron-anointing's established Hebron massing/palette"). One InstancedMesh
 * per structural part (socle/wall/roof), mirroring hebron-anointing's own
 * TownAndPlaza.tsx.
 */
