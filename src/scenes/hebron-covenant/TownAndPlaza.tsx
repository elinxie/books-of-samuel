...
/**
 * Hebron itself, reused unchanged from hebron-anointing (mandatory visual
 * continuity — brief: "do not re-invent Hebron"): `TOWN_HOUSES`/`GATE_POSTS`
 * are imported by reference from hebron-anointing/layout.ts via this scene's
 * own layout.ts, so the massing is pixel-identical across both scenes. Only
 * the rendering component itself is scene-local, per ADR-006 (layout code
 * stays scene-local; constants may be shared). See claim-hebron-town-form.
 */
