 ...
 * hebron-anointing/hebron-covenant established, reused here rather than
 * re-invented (brief's "identical Hebron continuity rule"). Scene-local
 * component per ADR-006; the placement algorithm mirrors
 * hebron-covenant/Vegetation.tsx exactly (a fresh seed, same shape).
 */
