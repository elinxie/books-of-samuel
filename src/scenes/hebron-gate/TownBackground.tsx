...
/**
 * Ambient townsfolk (`claim-gate-cast-scale`) — an ordinary working town
 * continuing around the day's events, deliberately smaller than the
 * mourning assembly. Fully static, baked once — same convention as
 * hebron-covenant's TownBackground.tsx/hebron-anointing's JudahAssembly.tsx.
 */
...
export function buildTownFigures(count: number, seed = 44501): TownFigure[] {
