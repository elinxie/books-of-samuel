...
/**
 * Dry-stone agricultural terracing, reused unchanged from hebron-anointing
 * (mandatory visual continuity) — `TERRACE_SEGMENTS` is imported by
 * reference via this scene's own layout.ts. See TerraceWalls.tsx in
 * hebron-anointing/hebron-covenant for the original composition notes.
 */
