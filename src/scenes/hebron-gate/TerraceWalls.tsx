...
/**
 * Dry-stone agricultural terracing on Hebron's south-facing flank — reuses
 * hebron-anointing's `TERRACE_SEGMENTS` layout data directly (same place,
 * same asset-terrace-walls), per the brief's continuity requirement.
 */
