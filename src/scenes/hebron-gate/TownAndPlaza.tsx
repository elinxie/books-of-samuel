...
/**
 * Hebron's town houses — the same modest hill-town cluster hebron-anointing
 * built (`claim-hebron-town-form`, `asset-hebron-town-form`), reused by
 * importing its layout data directly, per ADR-006 continuity. Unlike
 * hebron-anointing/hebron-covenant's own `TownAndPlaza.tsx`, the two gate
 * posts are not re-rendered here — this scene's gate is a full passage
 * structure (`GatePassage.tsx`, `asset-hebron-gate-passage`), built on the
 * same post line, so a duplicate pair of simple posts would just double up
