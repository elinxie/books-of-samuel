...
export const SCENES: SceneDef[] = [
  ...
  },
  {
    ...
    periodId: 'iron-iia',
    milestoneId: 'M5',
    // Built 2026-08-07 (Sonnet, threejs-engineer) per docs/design/hebron-covenant-brief.md
    // (Fable, 2026-08-03). First of three M5 scenes; hebron-gate and
    // hebron-reckoning remain separate future builds.
    status: 'in-progress',
    synopsis:
      'The civil war between the houses of Saul and David ends not by battle but by defection and negotiation. Abner, who made Ish-bosheth king, breaks with him and brings his twenty men to Hebron. David receives him with a feast; Abner pledges to gather all Israel to David, and departs in peace.',
    depictsDeath: false,
    durationSec: 152,
    beats: [
      {
        ...
        title: 'A long war',
        caption:
          'There is a long war between the house of Saul and the house of David. David grows steadily stronger; the house of Saul grows steadily weaker. Sons are born to David at Hebron — among them Amnon and Absalom, named here only as the text lists them, with no forward look at what they later do. (2 Samuel 3:1–5)',
        passageRef: '2 Samuel 3:1–5',
      },
      {
        id: 'b-break',
        timeSec: 14,
        title: 'Abner’s break with Ish-bosheth',
        caption:
          'Ish-bosheth accuses Abner of going in to Rizpah, Saul’s concubine — an accusation the narrative states but never confirms or denies. Abner answers with indignation, not confession, and swears to transfer the kingdom to David "from Dan to Beersheba." Ish-bosheth, afraid of him, says nothing more. Mahanaim, where this happens, is not built here. (2 Samuel 3:6–11)',
        passageRef: '2 Samuel 3:6–11',
      },
      {
        id: 'b-overture',
        timeSec: 28,
        title: 'Messengers, and a condition',
        caption:
          'Abner sends messengers proposing a covenant. David agrees, on one condition: the return of his wife Michal, taken from Paltiel during his exile. Ish-bosheth has her brought; Paltiel follows her weeping as far as Bahurim, until Abner sends him back. None of this is staged — it happens at places this project does not build, and is carried here as text alone. (2 Samuel 3:12–16)',
        passageRef: '2 Samuel 3:12–16',
      },
      {
        id: 'b-elders',
        timeSec: 42,
        title: 'Abner and the elders',
        caption:
          'Before coming to Hebron himself, Abner speaks with the elders of Israel and with Benjamin — the north’s own consent, gathered ahead of the visit. Text only; no council is staged. (2 Samuel 3:17–19)',
        passageRef: '2 Samuel 3:17–19',
      },
      {
        id: 'b-arrival',
        timeSec: 54,
        title: 'Abner comes up, with twenty men',
        caption:
          'Abner comes to David at Hebron, with twenty men — rendered literally, the text’s own exact count. They come up the road from the north, the direction of Israel and Benjamin: the deliberate inverse of David’s own approach from the south, years earlier. They are received without incident. (2 Samuel 3:20a)',
        passageRef: '2 Samuel 3:20a',
      },
      {
        id: 'b-feast',
        timeSec: 82,
        title: 'A feast, prepared',
        caption:
          'David makes Abner and his men a feast — an open-air meal, not a banquet hall. Quiet, formal, watchful: a working negotiation, not a celebration. This is the man who killed Asahel at the pool of Gibeon, received at David’s own table anyway. (2 Samuel 3:20b)',
      ...
      },
      {
        ...
        title: 'The pledge',
        caption:
          'Abner pledges to gather all Israel to David in a covenant, so that David may reign over everything he desires. A plain spoken pledge, not a formal rite — no ceremony is invented beyond it. (2 Samuel 3:21a)',
      ...
      },
      {
        ...
        caption:
          'David sends Abner away, and he goes in peace. The narrative will repeat that phrase twice more before it tells us what Joab does — this scene holds only the first occurrence, staged straight: a settled, public, unhurried dismissal, watched up the same northern road he came by. No dread, no foreboding — the text’s own irony needs none added here. (2 Samuel 3:21b)',
        passageRef: '2 Samuel 3:21b',
      },
      {
        id: 'b-close',
        timeSec: 146,
        title: 'What the peace does not yet know',
        caption:
          'Not shown: what happens next at this same gate, when Joab returns. That belongs to hebron-gate, the next scene — nothing from it, or from 2 Samuel 5 onward, is anticipated here.',
        passageRef: '2 Samuel 3:22–27',
      },
    ],
    viewpoints: [
      {
  ...
  {
    id: 'hebron-gate',
    title: 'Hebron — the killing at the gate, and the funeral',
    passageIds: ['2sam-3'],
    locationId: 'hebron',
    periodId: 'iron-iia',
    milestoneId: 'M5',
    // Built 2026-08-07 (Sonnet, threejs-engineer) per docs/design/hebron-gate-brief.md
    // (Fable, 2026-08-03). Second of three M5 scenes; the second application
    // of ADR-009's named-character-killing template (first: gibeon-pool).
    status: 'in-progress',
    synopsis:
      'Joab returns from a raid to find that David has received and released Abner in peace. He protests, then secretly recalls Abner and draws him aside into the midst of Hebron’s own gate, killing him — a breach of safe-conduct inside David’s own capital. David publicly disavows the killing, curses Joab’s house, and leads the mourning himself: Abner is buried at Hebron with a lament and a fast, and the people understand it was not the king’s will.',
    depictsDeath: true,
    durationSec: 220,
    beats: [
      {
        id: 'b-joab-returns',
        timeSec: 0,
        title: 'Joab returns, with much spoil',
        caption:
          'Joab and the servants of David return from a raid, bringing much spoil with them. Joab is told that Abner came to the king, was sent away, and has gone in peace — the narrative’s third repetition of that phrase. No violence yet. (2 Samuel 3:22–23)',
      ...
      },
      {
        ...
        caption:
          'Joab goes to David and protests: why did you let him go? Abner came to deceive you, he says — to learn your movements and everything you are doing. His own stated reading, carried here as his words; the text never says whether it is sincere or pretext. (2 Samuel 3:24–25)',
      ...
      },
      {
        ...
        title: 'The recall',
        caption:
          'Without David’s knowledge, Joab sends messengers after Abner; they overtake him at the cistern of Sirah, an unbuilt, unidentified site, and bring him back. "But David did not know it" — the text’s own insistence, stated exactly where it states it. (2 Samuel 3:26)',
      ...
      },
      {
        ...
        title: 'Taken aside',
        caption:
          'Abner re-enters the scene already returning through the gate. Joab takes him aside into the passage’s shaded interior, as if to speak with him privately — staged literally and minimally: no invented dialogue, no invented struggle beyond what the text gives. (2 Samuel 3:27a)',
        passageRef: '2 Samuel 3:27a',
      },
      {
        id: 'b-abner-death',
        timeSec: 62,
        title: 'In the midst of the gate',
        caption:
          'Joab strikes him there in the stomach, and he dies — "for the blood of Asahel his brother," though Joab’s own stated reason at his return was suspected treachery. Shown at documentary distance, at the gate’s shadow line; the fall reads by silhouette, with no wound or blood geometry in either mode. A short, unscored stillness follows on the gate itself. (2 Samuel 3:27b)',
        passageRef: '2 Samuel 3:27b',
      },
      {
        id: 'b-david-hears',
        timeSec: 80,
        title: 'David’s disavowal, and the curse',
        caption:
          'David declares himself and his kingdom innocent before the LORD of Abner’s blood forever, and calls down a curse on Joab’s house — a line never free of discharge, leprosy, the spindle, the sword, or hunger — delivered unsoftened here, never visualized in any mode. Abishai’s shared responsibility (3:30) is stated; the strike itself stays Joab’s alone. (2 Samuel 3:28–30)',
      ...
      },
      {
        ...
        caption:
          'David commands mourning: Joab himself tears his clothes and puts on sackcloth with the rest — the killer made a public mourner at his victim’s funeral, staged exactly as narrated, with no commentary on his interior state the text does not give. David takes his place behind the bier. (2 Samuel 3:31)',
        passageRef: '2 Samuel 3:31',
      },
      {
        id: 'b-procession',
        timeSec: 114,
        title: 'The bier, carried',
        caption:
          'Abner’s body, borne on a bier as a wrapped, anatomically unresolved form, is carried toward the tomb at funeral pace; the mourning crowd follows behind, David among them. A walking, guided pace — not a hurried one. (2 Samuel 3:31–32a)',
        passageRef: '2 Samuel 3:31–32a',
      },
      {
        id: 'b-burial-weep',
        timeSec: 140,
        ...
        caption:
          'Abner is buried at Hebron. David weeps aloud at the grave; all the people weep with him. Held, unhurried — the text gives this more weight than it gives the killing itself. (2 Samuel 3:32b)',
      ...
      },
      {
        ...
        title: 'The lament',
        caption:
          'David sings a lament over the grave: Abner did not die as a fool dies, hands unbound, feet unfettered — he fell as one falls before the wicked. No invented melody, the standing rule from Ziklag’s own lament. (2 Samuel 3:33–34)',
      ...
      },
      {
        ...
        caption:
          'The people urge David to eat while it is still day; he swears he will taste nothing until the sun goes down. Sundown lighting begins here, exactly where the text states the hour. (2 Samuel 3:35)',
      ...
      },
      {
        ...
        caption:
          'Everything the king does pleases the people; all Israel and all the people understand that day that it was not the king’s will that Abner died. The narrative’s own insistence — why it insists so emphatically stays in the claim layer, not in this caption. (2 Samuel 3:36–37)',
      ...
      },
      {
        ...
        caption:
          'David says to his servants, "Do you not know that a prince and a great man has fallen this day in Israel?" — and that though he is the anointed king, these men, the sons of Zeruiah, are too severe for him to control; the LORD will repay the wrongdoer. Closing at sundown; what happens next at this same Hebron belongs to hebron-reckoning alone. (2 Samuel 3:38–39)',
    ...
    viewpoints: [
      ...
      {
        id: 'vp-gate-shadow',
        label: 'The gate’s interior shadow',
        position: [0, 3, -24],
        lookAt: [-4.2, 2.4, -42],
      },
      {
  ...
  {
    id: 'hebron-reckoning',
    title: 'Hebron — the reckoning for Ish-bosheth',
    passageIds: ['2sam-4'],
    locationId: 'hebron',
    periodId: 'iron-iia',
    milestoneId: 'M5',
    // Built 2026-08-07 (Sonnet, threejs-engineer) per
    // docs/design/hebron-reckoning-brief.md (Fable, 2026-08-03). Third and
    // last scene of Milestone 5; the third application of ADR-009's
    // named-killing template, the first as a judicial act, and the first
    // scene to trigger ADR-009's absolute dismemberment bar (the
    // hands-and-feet display renders as caption text only, in every mode —
    // no geometry stands in for it, unlike Beth-shan's whole-body display
    // forms). ziklag-lament's deliberate structural twin (4:10 is David's own
    // retelling of that scene).
    status: 'in-progress',
    synopsis:
      'Ish-bosheth’s own captains, Rechab and Baanah, assassinate him in his own house at noon and carry his head to Hebron, expecting reward. David answers by recalling his own execution of the messenger who once claimed to have killed Saul at Ziklag, judges the two as wicked men who killed a righteous man in his own house on his bed, has them executed near the pool of Hebron, and buries Ish-bosheth’s head in Abner’s tomb — the same tomb, days apart. The house of Saul’s last king ends in murder, not battle, and David disavows it again.',
    depictsDeath: true,
    durationSec: 140,
    beats: [
      {
        ...
        title: 'Courage fails',
        caption:
          'When Ish-bosheth, Saul’s son, hears that Abner has died at Hebron, his courage fails, and all Israel is dismayed. Saul had two captains of raiding bands in his service, Rechab and Baanah, sons of Rimmon the Beerothite — Beeroth itself reckoned to Benjamin, though its people had fled to Gittaim. A context card only; nothing is staged yet. (2 Samuel 4:1–3)',
        passageRef: '2 Samuel 4:1–3',
      },
      {
        id: 'b-mephibosheth',
        timeSec: 13,
        title: 'What remains of the house',
        caption:
          'The text inserts its own aside here, not later: Jonathan had a son, lame in both feet — five years old when the news came from Jezreel of his father’s and grandfather’s deaths, and his nurse, fleeing with him, let him fall. His name was Mephibosheth. A card only, never staged as a figure, with nothing here pointing forward to where he reappears much later in the story. (2 Samuel 4:4)',
      ...
      },
      {
        ...
        title: 'At noon rest',
        caption:
          'Rechab and Baanah come to Ish-bosheth’s house at noon, while he rests. The Hebrew text is itself disputed here — did the two enter under pretext of fetching wheat, or did a drowsing doorkeeper let them slip past unnoticed? Both readings are carried in the claim layer, not staged here. They kill him in his bed, behead him, and travel all night by way of the Arabah. Mahanaim is disputed and unbuilt, so nothing here is staged, and no anatomy is ever shown, in either mode. (2 Samuel 4:5–7)',
      ...
      },
      {
        ...
        caption:
          'The two come up the Arabah road toward Hebron as the light comes up, carrying a small covered bundle, low — never brandished, never framed as a trophy. The morning-arrival hour is a disclosed inference from the overnight march (4:7b), not an asserted text detail. (2 Samuel 4:8a)',
        passageRef: '2 Samuel 4:8a',
      },
      {
        id: 'b-presentation',
        timeSec: 56,
        title: 'A claim of reward',
        caption:
          'They present the bundle to David, claiming "the LORD has avenged my lord the king this day on Saul and his offspring" — carried here as their own words, petitioners expecting reward, not the narrative’s own verdict on them. (2 Samuel 4:8b)',
      ...
      },
      {
        ...
        title: 'Ziklag, retold',
        caption:
          'David answers by recalling his own words from years before, at Ziklag: when a man told him Saul was dead and expected a reward for it, David seized him and killed him there. This, he says, is worse — Rechab and Baanah have killed "a righteous man in his own house on his bed." The same pattern, the harsher verdict; this scene’s ESV excerpt spend lands here. (2 Samuel 4:9–11)',
      ...
      },
      {
        ...
        caption:
          'At David’s command, the young men kill Rechab and Baanah near the pool of Hebron — documentary distance, no gesture invented for the strike, since the text gives no method to show. Reduced mode cuts straight from the command to this aftermath. The text also states their hands and feet were cut off and hung up beside the pool; that fact is carried here in caption text only, in every mode — no geometry stands in for it. (2 Samuel 4:12a)',
        passageRef: '2 Samuel 4:12a',
      },
      {
        id: 'b-burial',
        timeSec: 110,
        title: 'The same tomb, days apart',
        caption:
          'The covered bundle is carried to Abner’s tomb at Hebron and buried there — the same tomb, the same ground, days after Abner’s own burial. The text does not state David’s own presence at this burial, unlike Abner’s, so none is staged here. (2 Samuel 4:12b)',
      ...
      },
      {
        ...
        caption:
          'The house of Saul’s last king is dead and buried at Hebron — not by David’s hand, and, on the narrative’s own repeated insistence across this milestone, not by his will either. The chapter, and this milestone, end here: nothing from 2 Samuel 5 onward is shown or anticipated.',
    ...
    viewpoints: [
      ...
      {
        id: 'vp-arabah-road',
        label: 'The road from the Arabah',
        position: [200, 16, -80],
        lookAt: [58, 3, -27],
      },
      {
    ...
    claimIds: [
      ...
      'claim-mephibosheth-parenthesis',
