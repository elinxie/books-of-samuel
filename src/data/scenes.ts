...
export const SCENES: SceneDef[] = [
  ...
  {
    id: 'hebron-unification',
    title: 'All Israel anoints David at Hebron',
    passageIds: ['2sam-5'],
    locationId: 'hebron',
    periodId: 'iron-iia',
    milestoneId: 'M6',
    status: 'planned',
    synopsis:
      'All the tribes of Israel come to David at Hebron, recall his prior service under Saul, make a covenant with him before the LORD, and anoint him king over all Israel — ending the Judah/Israel split the M4/M5 atlas has tracked since 2 Samuel 2. First of three M6 scenes; not yet built. Brief pending (docs/design/hebron-unification-brief.md).',
    durationSec: 0,
    beats: [],
    viewpoints: [],
    claimIds: [],
  ...
  {
    id: 'jerusalem-conquest',
    title: 'The Jebusite conquest and the City of David',
    passageIds: ['2sam-5'],
    ...
    status: 'planned',
    synopsis:
      'David and his men take the Jebusite stronghold, rename it the City of David, and build it up from the Millo inward; Hiram of Tyre sends materials and craftsmen for a house. First Jerusalem geometry in the project — the location carries a genuine maximalist-vs-minimalist scholarly dispute over the 10th-century town’s scale, not yet resolved. Second of three M6 scenes; not yet built. Brief pending (docs/design/jerusalem-conquest-brief.md).',
    durationSec: 0,
    beats: [],
    viewpoints: [],
    claimIds: [],
  ...
  {
    id: 'baal-perazim-rephaim',
    title: 'The Philistine campaigns at Baal-perazim and the Valley of Rephaim',
    passageIds: ['2sam-5'],
    ...
    status: 'planned',
    synopsis:
      'On hearing a king now rules a united Israel, the Philistines come up twice seeking David. At Baal-perazim, David inquires of the LORD and routs them “as a breach of waters.” At the Valley of Rephaim, told instead to circle behind and wait for “the sound of marching in the tops of the balsam trees” as the LORD’s own sign. Third of three M6 scenes; not yet built. Brief pending (docs/design/baal-perazim-rephaim-brief.md).',
    durationSec: 0,
    beats: [],
    viewpoints: [],
    claimIds: [],
