...
export const LOCATIONS: LocationEntry[] = [
  ...
  },
  {
    ...
    // (M5, 2026-08-10) adds itself to sceneIds without changing this
    // location's own `released` status, which describes the location record
    // itself, not every scene built at it.
    status: 'released',
  },
  {
    id: 'gibeon',
